...
-- x1	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- x3	=>  Location: PIN_M5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- x2	=>  Location: PIN_L7,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Assignment8 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \f~0_combout\ = (\x3~input_o\ & ((\x2~input_o\) # (\x1~input_o\))) # (!\x3~input_o\ & (\x2~input_o\ & \x1~input_o\))
